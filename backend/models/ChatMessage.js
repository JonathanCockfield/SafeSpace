...
// function returns a conversation given a chat room ID
...
// function will delete all messages from a given room
chatMessageSchema.statics.deleteMessagesByRoom = async function (chatRoomId) {
  try {
    return this.deleteMany({ chatRoomId: chatRoomId });
  } catch (error) {
    throw error;
  }
}
